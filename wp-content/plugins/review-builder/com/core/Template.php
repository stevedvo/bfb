...
class Template
{
	...
	public function findHtmlTitle($html)
	{
		...
		return '<textarea rows="8" class="'.$styleClass.' '.$tagClass.'" placeholder="'.$placeholder.'" name="input_html['.$tag.'][]">'.@$options['html'][$tag][($this->autoIncrement-1)].'</textarea>';
	}
	...
	public function findUrl($html)
	{
		...
		if ($this->id) {
			...
			return '<textarea rows="8" class="sgrb-link '.$tagClass.'" placeholder="'.$placeholder.'" name="input_url[]">'.@$options['url'][$linkCount++].'</textarea>
					<textarea rows="8" class="sgrb-link-title" placeholder="'.$placeholderLink.'" name="input_url[]">'.@$options['url'][$linkCount++].'</textarea>';
			
		}
		return '<textarea rows="8" class="sgrb-link '.$tagClass.'" placeholder="'.$placeholder.'" name="input_url[]"></textarea>
