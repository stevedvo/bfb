...
class SgrbWidget extends WP_Widget
{
	...
	public function form($instance)
	{
		...
		$html .= '<div style="padding: 10px 0;"><i style="color:#ff0000;">Note: not allow to set a review and widget review on the same page!</i><p>Select review to show:</p><select id="'.$reviewId.'" name="'.$reviewTitle.'">';
